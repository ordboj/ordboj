...
//   docs/verb-data/candidates.csv  — ~1537 rows, source of record, ~35% error rate
...
const CSV_PATH = join(ROOT, 'docs/verb-data/candidates.csv');
...
function main() {
  ...
  if (!checkOnly) {
    ...
    const proposedLines = [
      '// Generated by scripts/build-verb-data.mjs from docs/verb-data/candidates.csv.',
