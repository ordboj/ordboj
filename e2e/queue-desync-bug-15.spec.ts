...
test.describe('regression #103: queue no longer desyncs after answering', () => {
  test('answering the first of two due cards shows the second card, then completion', async ({
    ...
    // Header reads answeredToday / dailyGoal since issue #26: nothing
    // answered yet, default goal 50.
    ...
    // progress counter (one answer recorded toward the goal of 50) and
    // answer input are all still present.
