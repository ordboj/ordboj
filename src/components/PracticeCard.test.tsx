...
describe('PracticeCard - mobile input attributes (#113)', () => {
  ...
  it("matches a decomposed (NFD) å/ä/ö answer against the app's NFC-stored correct answer", async () => {
    // "gå" presens is "går" (NFC: "g" + "å" U+00E5 + "r"). A hardware
    // keyboard / IME can produce the canonically-equivalent NFD form
    ...
    const nfdGar = 'g' + 'å' + 'r'; // NFD equivalent of "går"
