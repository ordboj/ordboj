...
export default function Progress() {
  ...
  const handleSortKeyDown = (field: SortField) => (event: KeyboardEvent) => {
  ...
  const handleRowKeyDown = (verb: ConjugatedVerb) => (event: KeyboardEvent) => {
    if (event.key === 'Enter' || event.key === ' ') {
      event.preventDefault();
              ...
              <TableHeader className="sticky top-0 bg-background z-10">
                <TableRow>
                  <TableHead
                    ...
                    role="button"
                    tabIndex={0}
                    aria-sort={getAriaSort('infinitive')}
                    onClick={() => toggleSort('infinitive')}
                    onKeyDown={handleSortKeyDown('infinitive')}
                  >
                  ...
                  <TableHead
                    ...
                    onKeyDown={handleSortKeyDown('difficulty')}
                  >
                    <div className="flex items-center gap-2">
                      Difficulty
                      <ArrowUpDown className="w-4 h-4" />
                ...
                {filteredAndSortedVerbs.map((verb, index) => {
                  ...
                  return (
                    <TableRow
                      ...
                      onKeyDown={handleRowKeyDown(verb)}
                    >
