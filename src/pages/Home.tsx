...
export default function Home() {
  ...
  // No settings->selectedLevels sync effect needed: useSettings hydrates
  // synchronously, so the useState initializer above already sees the stored
  // levels, and handleLevelToggle keeps both in step afterwards.
