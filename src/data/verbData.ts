...
export interface VerbData {
  ...
  grupp?: Grupp;
  // True only for modal/auxiliary verbs (kunna, få, vilja, ...) that have no
  // natural imperativ in Swedish. Distinguishes "this form doesn't exist for
  // this verb" from "we haven't filled it in yet" (imperativ: "" with this
  // flag unset/false). Consumers must not quiz a form flagged true here.
...
export const VERB_DATA: VerbData[] = [
  ...
  // Modal verb: no natural imperativ in Swedish. imperativ stays "" and is
  // explicitly flagged, not merely omitted (see imperativNotApplicable doc).
  { cefr: "A1", infinitive: "kunna", imperativ: "", presens: "kan", preteritum: "kunde", supinum: "kunnat", grupp: "4", imperativNotApplicable: true },
  { cefr: "A1", infinitive: "unna", imperativ: "unna", presens: "unnar", preteritum: "unnade", supinum: "unnat", grupp: "1" },
  // Modal verb: no natural imperativ in Swedish.
  { cefr: "A1", infinitive: "få", imperativ: "", presens: "får", preteritum: "fick", supinum: "fått", grupp: "4", imperativNotApplicable: true },
  ...
  // Modal verb: no natural imperativ in Swedish.
  { cefr: "A1", infinitive: "vilja", imperativ: "", presens: "vill", preteritum: "ville", supinum: "velat", grupp: "4", imperativNotApplicable: true },
  ...
  // NEEDS HUMAN CHECK: reflexive particle verb. Grupp 3's mechanical
  // imperativ=infinitive rule doesn't address the sig->dig swap that
  // reflexive verbs typically take in the imperativ (cf. "sätta sig" ->
  // "sätt dig"); not guessing "te dig" without a reference check.
  ...
  // NEEDS HUMAN CHECK: grupp 4 irregular verb, imperativ must be verified
  // against a reference rather than pattern-matched from presens. "anse"
  // ("to deem/consider") is also not attested in imperativ use in common
  // reference material available here; not guessing "anse"/"ans".
