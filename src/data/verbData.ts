...
export const VERB_DATA: VerbData[] = [
  ...
  // "te sig" and "anse". Both are deliberate per their own inline comments.
  // No other row needs a fix. verbData.test.ts pins this set, so a new
  // unflagged empty row fails CI. "anse" stays unfilled: the candidate
  // phrase "anse dig varnad" is not confidently attested, and CLAUDE.md
  // prefers missing Swedish over wrong Swedish. The human ruling below
  // still stands.
