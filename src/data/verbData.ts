...
export const VERB_DATA: VerbData[] = [
  ...
  // "kunna" is a modal verb with no imperativ mood in Swedish; empty is correct, not a data gap.
  ...
  // "få" is used here as a modal/auxiliary ("be allowed to"); no imperativ mood, empty is correct.
  ...
  // "vilja" is a modal verb with no imperativ mood in Swedish; empty is correct, not a data gap.
  ...
  // "te sig" (reflexive, "to appear/seem") has no attested natural imperativ usage;
  // left empty rather than guessing "te dig" — needs human check before filling.
