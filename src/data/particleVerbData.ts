...
export const PARTICLE_VERB_DATA: ParticleVerbData[] = [
  ...
  // row, so it stays out per the #317 gate rather than shipping unverifiable.
  {
    ...
    examples: [
      ...
      { sv: 'Volontärerna delar ut mat till hemlösa varje vecka.', blankIndex: 2 },
      { sv: 'Vi delar ut flygblad utanför affären på lördagar.', blankIndex: 2 },
    ],
    verified: true,
  ...
  },
  {
    ...
    acceptedParticles: ['till'],
    examples: [
      { sv: 'Kan du hjälpa till med disken ikväll?', blankIndex: 3 },
      { sv: 'Barnen hjälper alltid till när vi flyttar möbler.', blankIndex: 3 },
      { sv: 'Vi hjälpte till att bära lådorna upp för trappan.', blankIndex: 2 },
    ],
    verified: true,
  ...
  },
  {
    ...
    examples: [
      ...
      { sv: 'Hon lånade ut sin bil till en vän förra veckan.', blankIndex: 2 },
    ],
    verified: true,
  ...
  },
  {
    ...
    examples: [
      ...
      { sv: 'Vi spelade in hela konserten med en kamera.', blankIndex: 2 },
      { sv: 'Programmet spelas in live varje torsdagskväll.', blankIndex: 2 },
    ],
    verified: true,
  ...
  },
  {
    ...
    acceptedParticles: ['ut'],
    examples: [
      { sv: 'Laget slog ut favoriterna i kvartsfinalen igår.', blankIndex: 2 },
      { sv: 'Körsbärsträden slår ut i full blom varje april.', blankIndex: 2 },
      { sv: 'Han slogs ut redan i den första omgången.', blankIndex: 2 },
    ],
    verified: true,
  ...
  },
  {
    ...
    examples: [
      ...
      { sv: 'Ta det lugnt och koppla av lite ikväll.', blankIndex: 5 },
    ],
    verified: true,
  ...
  },
  {
    ...
    examples: [
      ...
      { sv: 'Hon slog upp adressen på sin telefon direkt.', blankIndex: 2 },
    ],
    verified: true,
  ...
  },
  {
    ...
    acceptedParticles: ['tillbaka'],
    examples: [
      { sv: 'Jag måste lämna tillbaka boken imorgon bitti.', blankIndex: 3 },
      { sv: 'Hon lämnade tillbaka nyckeln till hyresvärden igår.', blankIndex: 2 },
