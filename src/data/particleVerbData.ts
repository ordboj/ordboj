...
export const PARTICLE_VERB_DATA: ParticleVerbData[] = [
  ...
  //
  // A second batch is also owed. Fifteen further rows in this rank range were
  // authored and checked, then held back because their particle (hem, igång,
  // åt, ihop, samman, fast, undan, an, hemma) has no line in
  // PARTICLE_CORE_SENSE in src/lib/particleVerbs.ts, and
  // particleVerbs.test.ts requires one for every particle that ships. That is
  // a copy gap in a file this change does not own, not a defect in the verbs.
  {
    id: 'pv:veta-om',
    cefr: 'A2',
    cefrEvidence: 'svalex',
